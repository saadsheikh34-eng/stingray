...
#
# Generated by Vivado on Thu Jul 16 19:23:45 +0800 2020
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ipshared/70cf/hdl" +incdir+"$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ip/design_1_processing_system7_0_0" +incdir+"C:/Xilinx/2018.3/Vivado/2018.3/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ipshared/70cf/hdl" +incdir+"$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ip/design_1_processing_system7_0_0" +incdir+"C:/Xilinx/2018.3/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_vip_v1_1_4 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ipshared/70cf/hdl" +incdir+"$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ip/design_1_processing_system7_0_0" +incdir+"C:/Xilinx/2018.3/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ipshared/98af/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work processing_system7_vip_v1_0_6 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ipshared/70cf/hdl" +incdir+"$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ip/design_1_processing_system7_0_0" +incdir+"C:/Xilinx/2018.3/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../zynq_lwip_demo.srcs/sources_1/bd/design_1/ipshared/70cf/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log
